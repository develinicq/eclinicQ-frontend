...
const DropdownMenu = ({
    ...
    return (
        <div
            className={`absolute z-[50] right-0 top-full mt-1 ${width} rounded-lg bg-white p-2 animate-in fade-in zoom-in-95 duration-100 shadow-[0px_12px_60px_-15px_rgba(0,0,0,0.06)] border border-secondary-grey100 ${className}`}
            role="listbox"
        >
            <div
                ...
                {items.map((m, idx) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {isSelected && (
                                <img src={checkBlue} alt="" className="" />
                            )}
                        </button>
                    );
                })}
