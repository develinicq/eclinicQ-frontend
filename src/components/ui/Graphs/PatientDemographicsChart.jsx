...
const data = [
  { ageGroup: "0-18", male: 400, female: 200, others: 60 },
  { ageGroup: "19-35", male: 440, female: 220, others: 40 },
  { ageGroup: "36-50", male: 510, female: 300, others: 70 },
  { ageGroup: "50-65", male: 530, female: 180, others: 65 },
  { ageGroup: "65+", male: 600, female: 380, others: 75 },
];

const legendItems = [
  { key: "male", label: "Male", color: "#2372ec" },
  { key: "female", label: "Female", color: "#eb8b85" },
  { key: "others", label: "Others", color: "#96BFFF" },
];
          ...
          >
            ...
            {data.map((_, index) =>
               (
                <ReferenceArea
                  key={index}
                  x1={data[index].ageGroup}
                  x2={data[index].ageGroup}
                  fill="#FFFFFF"
                  fillOpacity={1}
                />
              )
