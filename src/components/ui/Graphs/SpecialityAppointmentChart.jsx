  ...
  return (
    <div className="w-full bg-white rounded-lg p-6 border border-secondary-grey100">
      <div className="flex justify-between items-start mb-2">
        <div>
          <h3 className="text-lg font-semibold text-secondary-grey400">Speciality Appointment Booked</h3>
          <p className="text-xs text-secondary-grey200">Appointment metrics by speciality</p>
        </div>
