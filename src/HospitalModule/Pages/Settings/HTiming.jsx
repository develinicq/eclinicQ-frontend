...
export default function HTiming(){
  ...
  return (
    <div className="px-6 pb-10">
      ...
      {activeTab === 'timing' && (
        <div className="mt-4">
          <SectionCard title="Timing and Schedule">
                  ...
                  <div key={day} className="border border-gray-200 rounded-lg p-3">
                    ...
                    <div className={`mt-2 space-y-2 ${!enabled ? 'opacity-60' : ''}`}>
                      ...
                      <div className="grid grid-cols-12 items-center gap-2">
                        ...
                        <div className="col-span-6 sm:col-span-3"><TimeInput label="" disabled={!enabled || allDay[day]} defaultValue={'09:00 AM'} /></div>
                        <div className="col-span-6 sm:col-span-3"><TimeInput label="" disabled={!enabled || allDay[day]} defaultValue={'06:00 PM'} /></div>
                        <div className="col-span-12 sm:col-span-3 text-right">
                          <button type="button" disabled={!enabled || allDay[day]} onClick={()=>addSession(day)} className={`text-sm text-blue-600 ${!enabled || allDay[day] ? 'opacity-50 cursor-not-allowed' : 'hover:underline'}`}>+ Add More</button>
                        </div>
                      </div>
                      {/* extra sessions */}
