        ...
        <div className="sticky top-0 z-10 bg-white border-b border-gray-200 px-4 py-1 flex items-center">
          ...
          <div className="flex ml-auto items-center gap-4">
            <div className="flex gap-2 items-center">
              <span className="text-sm text-secondary-grey400">
                Tokens available
              </span>
            ...
            <div>
              <div
                className={`w-full h-[38px] flex items-center relative px-0 rounded-none ${
                  queuePaused ? "bg-[#FFF4E5]" : "bg-[#22C55E]"
                }`}
              >
                <div className="flex-1 flex items-center justify-center gap-3">
                  <span
                    className={`${
                      queuePaused ? "text-[#92400E]" : "text-white"
                    } font-medium text-[16px]`}
                  >
                    Current Token Number
                  </span>
                  <span
                    className={`inline-flex items-center gap-2 font-bold text-[18px] ${
                      queuePaused ? "text-[#92400E]" : "text-white"
                    }`}
                  >
                    <span
                      className={`inline-block w-3 h-3 rounded-full ${
                        queuePaused
                          ...
                          : "bg-[#D1FADF] border border-[#A7F3D0]"
                      }`}
                    ></span>
                    ...
                    <span
                      className={`ml-1 ${
                        activeFilter === f
                          ...
                          : "border-gray-200"
                      } border  px-[.25rem] bg-white rounded-md text-xs`}
                    >
                      {getFilterCount(f)}
                    </span>
                  </button>
            ...
            <div className="fixed inset-0 z-[10000] flex items-center justify-center">
              ...
              <div className="relative bg-white rounded-xl shadow-2xl border border-gray-200 w-[420px] max-w-[90vw] p-4">
                <div className="flex items-center justify-center mb-2">
                  <div className="w-10 h-10 rounded-full border-2 border-red-300 flex items-center justify-center text-red-500">
                    ⏸
                  </div>
                </div>
                <h3 className="text-center text-[16px] font-semibold text-gray-900">
                  Set Pause Duration
                </h3>
                <p className="text-center text-[12px] text-gray-600 mt-1">
                  Select duration to pause your queue. It will resume
                  automatically.
                </p>
                ...
                <div className="flex items-center gap-2 mt-4">
                  <button
                    className="flex-1 px-3 py-2 rounded-md border border-gray-300 text-sm text-gray-700 hover:bg-gray-50"
                    onClick={() => setShowPauseModal(false)}
                  >
                    Cancel
                  </button>
                ...
                <div className="mt-2 text-[11px] text-gray-500 flex items-center">
                  <span className="inline-block w-4 h-4 mr-1 text-gray-400">
                    ℹ️
                  </span>
