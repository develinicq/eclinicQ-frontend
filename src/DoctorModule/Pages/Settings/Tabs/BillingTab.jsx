...
const navigate=useNavigate()
  return (<>
    <div className=" space-y-6 p-4">
      ...
      <div className="border border-border border-blue-primary400 p-6">
 ...
 {planIcons[subscriptionData.plan.split(" ")[1]]}
            ...
            <div>
              <p className="text-sm text-secondary-grey300">Current Subscription</p>
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-semibold">
                  {subscriptionData.plan}
                </h2>
          <span className="inline-flex items-center text-success-400 bg-success-100 px-2 py-0.5 rounded-md border border-success-400 text-xs font-medium">
  <svg
  ...
  {subscriptionData.status}
          ...
          <a href="/billing/upgrade-plan">
            <button className="border px-2 bg-blue-primary100 text-sm py-2 rounded flex items-center gap-2 text-blue-primary250">
      ...
      <div className="border border-border">
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[700px]">
            <thead className=" text-xs text-secondary-grey300">
              <tr>
...
function Info({ label, value }) {
  return (
    <div>
      <p className="text-xs text-secondary-grey300 mb-1">{label}</p>
