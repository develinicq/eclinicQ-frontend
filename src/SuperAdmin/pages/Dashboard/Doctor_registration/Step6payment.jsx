...
<path fill-rule="evenodd" clip-rule="evenodd" d="M37.0207 47.976L28.2873 48.0001C28.2873 48.0001 25.2854 47.0654 25.2854 46.0111C25.2854 44.9567 27.8555 43.5449 28.1433 42.3208C28.5048 40.7841 27.4888 39.6802 25.5221 38.8161C23.8202 38.0684 22.9589 37.1968 24.9222 36.0484C26.5405 35.1018 26.0979 33.4845 26.0979 33.4845L25.606 31.6513C25.606 31.6513 28.689 30.9562 29.445 32.9811C30.4973 35.7996 26.4792 36.4189 28.7491 37.6783C29.6562 38.1816 36.3115 39.1949 32.739 42.393C29.1167 45.6356 34.3464 47.3683 37.0207 47.976Z" fill="url(#paint0_linear_2576_11643)"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M10.5583 48C10.5583 48 8.97472 45.153 14.8774 42.4166C20.7801 39.6801 18.2727 38.7262 18.2727 38.7262C18.2727 38.7262 17.0236 37.4957 18.7698 36.4455C20.5161 35.3954 22.062 34.1127 22.3904 33.0586C22.7188 32.0045 23.7474 30.9146 23.7474 30.9146L25.7315 33.6005L24.0744 35.5868C23.4123 36.2456 22.4911 36.7097 21.8352 37.6482C21.1794 38.5867 22.9856 39.719 23.1249 40.1702C23.2642 40.6215 23.7961 41.5063 20.3036 43.5448C16.811 45.5834 17.1678 48 17.1678 48H10.5583ZM23.7474 47.9984V48H17.1678L23.7474 47.9984Z" fill="url(#paint1_linear_2576_11643)"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M17.1665 48.0001C17.1665 48.0001 16.8097 45.5835 20.3023 43.5449C23.7949 41.5064 23.2629 40.6216 23.1236 40.1703C22.9843 39.7191 20.9859 38.862 21.834 37.6483C22.6821 36.4347 24.6106 35.0664 24.8812 34.1378L25.606 31.6514L26.0979 33.4846C26.0979 33.4846 26.5406 35.1019 24.9223 36.0484C22.9589 37.1968 23.8203 38.0684 25.5221 38.8161C27.4888 39.6802 28.5048 40.7842 28.1434 42.3209C27.8555 43.5449 25.2855 44.9568 25.2855 46.0111C25.2855 47.0324 28.1023 47.9414 28.2787 47.9974L17.1665 48.0001Z" fill="#80E2DE"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M24.4655 6.53711L12.0723 30.5306H20.314L24.4655 6.53711Z" fill="url(#paint2_linear_2576_11643)"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M28.7159 30.5306L24.4629 6.53711L37.0188 30.5306H28.7159Z" fill="url(#paint3_linear_2576_11643)"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M24.464 35.587V6.53711L20.3125 30.5306L24.464 35.587Z" fill="url(#paint4_linear_2576_11643)"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M24.4629 35.587V6.53711L28.7159 30.5306L24.4629 35.587Z" fill="url(#paint5_linear_2576_11643)"/>
<ellipse cx="6.54598" cy="5.9918" rx="1.09091" ry="1.08945" fill="white"/>
<ellipse cx="40.3643" cy="13.0733" rx="1.09091" ry="1.08945" fill="white"/>
<ellipse cx="32.1802" cy="6.53691" rx="0.545453" ry="0.544727" fill="white"/>
<ellipse cx="12.0005" cy="12.5286" rx="0.545453" ry="0.544727" fill="white"/>
<ellipse cx="3.81889" cy="26.1473" rx="0.545453" ry="0.544727" fill="white"/>
<ellipse cx="40.9107" cy="26.1473" rx="0.545453" ry="0.544727" fill="white"/>
<ellipse cx="44.7271" cy="5.99199" rx="0.545453" ry="0.544727" fill="white"/>
<ellipse cx="9.27255" cy="21.7892" rx="1.09091" ry="1.08945" fill="white"/>
<ellipse cx="40.9093" cy="32.6837" rx="1.09091" ry="1.08945" fill="white"/>
<defs>
<linearGradient id="paint0_linear_2576_11643" x1="27" y1="31.5944" x2="34.074" y2="52.2998" gradientUnits="userSpaceOnUse">
<stop stop-color="#00B1BC"/>
<stop offset="1" stop-color="#75D9A3"/>
</linearGradient>
<linearGradient id="paint1_linear_2576_11643" x1="15.0016" y1="31.5944" x2="17.9938" y2="50.3887" gradientUnits="userSpaceOnUse">
<stop offset="0.320084" stop-color="#75D9A3"/>
<stop offset="1" stop-color="#00B1BC"/>
</linearGradient>
<linearGradient id="paint2_linear_2576_11643" x1="11.9348" y1="53.5568" x2="24.1512" y2="53.5568" gradientUnits="userSpaceOnUse">
<stop stop-color="#00B1BC"/>
<stop offset="1" stop-color="#75D9A3"/>
</linearGradient>
<linearGradient id="paint3_linear_2576_11643" x1="24.3236" y1="53.5568" x2="36.7005" y2="53.5568" gradientUnits="userSpaceOnUse">
<stop stop-color="#00B1BC"/>
<stop offset="1" stop-color="#75D9A3"/>
</linearGradient>
<linearGradient id="paint4_linear_2576_11643" x1="20.2664" y1="63.4658" x2="24.3587" y2="63.4658" gradientUnits="userSpaceOnUse">
<stop stop-color="#00B1BC"/>
<stop offset="1" stop-color="#199EA4"/>
</linearGradient>
<linearGradient id="paint5_linear_2576_11643" x1="24.4157" y1="63.4658" x2="28.6081" y2="63.4658" gradientUnits="userSpaceOnUse">
<stop stop-color="#00B1BC"/>
<stop offset="1" stop-color="#75D9A3"/>
</linearGradient>
</defs>
...
export default function Step6Payment() {
  ...
  const selectedPlanId = state?.plan || "plus";
const availablePlans = plans.filter(plan => !plan.isTrial);
...
const [isPlanOpen, setIsPlanOpen] = useState(false);
  ...
  const [billingCycle, setBillingCycle] = useState(state.billingCycle || "monthly");
  const [doctors, setDoctors] = useState(state.doctors || 1);
  const [staff, setStaff] = useState(state.staff || 1);
  const [agreedToTerms, setAgreedToTerms] = useState(false);
  const basePrice = Number(
  selectedPlanData.price.replace(/[₹,]/g, "")
);

  const months = billingCycle === "monthly" ? 1 : billingCycle === "halfYearly" ? 6 : 12;
  const freeMonths = billingCycle === "halfYearly" ? 1 : billingCycle === "yearly" ? 2 : 0;
  const baseTotal = basePrice * months;
  const bonus = basePrice * freeMonths;
  const subtotal = baseTotal - bonus;
  const taxes = Math.round(subtotal * 0.18);
  const total = subtotal + taxes;
  const savings = bonus + Math.round(bonus * 0.18);
  const handleConfirm = () => {
    navigate("/success");
  };
  return (
...
<rect width="127" height="30" fill="white"/>
          ...
          <a href="" className="text-xs md:text-sm text-secondary-grey200 hidden sm:inline hover:text-foreground">
            Doctor Onboarding
          </a>
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-2">
              <h1 className="text-2xl font-bold text-secondary-grey400 mb-2">
                Package & Payment
              </h1>
              ...
              <p className="text-xs text-secondary-grey200 mt-1">2 of 2</p>
            </div>
