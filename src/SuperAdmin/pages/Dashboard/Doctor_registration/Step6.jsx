...
import StepSidebar from "../../../components/RegistrationSidebar/SidebarSteps";

const steps = [
  { number: 1, title: "Account Creation", status: "completed" },
  { number: 2, title: "Professional Details", status: "completed" },
  { number: 3, title: "Clinical Details", status: "completed" },
  { number: 4, title: "Review & Create", status: "completed" },
  { number: 5, title: "Package & Payment", status: "current" },
];
...
export default function Step6() {
  ...
  return (
    <div className="h-screen bg-background flex flex-col no-scrollbar ">
      <header className="h-10 md:h-12 bg-card border-b border-border flex items-center justify-between px-4 md:px-6">
        <div className="flex items-center gap-2 overflow-hidden">
          <div className="px-4 py-3">
            ...
            >
              <g clip-path="url(#clip0_4903_68514)">
                ...
                />
                <path
                  d="M14.3529 5.70454C15.3903 5.70454 16.2312 4.86372 16.2312 3.82651C16.2312 2.78931 15.3903 1.94849 14.3529 1.94849C13.3155 1.94849 12.4746 2.78931 12.4746 3.82651C12.4746 4.86372 13.3155 5.70454 14.3529 5.70454Z"
                  fill="#87AFFF"
                  stroke="white"
                  stroke-width="0.5"
                  stroke-miterlimit="22.9256"
                ...
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M112.498 10.1104H112.498C112.923 10.1104 113.27 10.4581 113.27 10.8831V12.4675H114.855C115.28 12.4675 115.628 12.8152 115.628 13.2402V13.2403C115.628 13.6653 115.28 14.013 114.855 14.013H113.27V15.5974C113.27 16.0224 112.923 16.3701 112.498 16.3701H112.498C112.072 16.3701 111.725 16.0224 111.725 15.5974V14.013H110.14C109.715 14.013 109.367 13.6653 109.367 13.2403V13.2402C109.367 12.8152 109.715 12.4675 110.14 12.4675H111.725V10.8831C111.725 10.4581 112.072 10.1104 112.498 10.1104Z"
                  fill="#87AFFF"
                />
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M122.952 20.6934C124.406 20.6934 125.585 21.8723 125.585 23.3265C125.585 24.7807 124.406 25.9597 122.952 25.9597C121.497 25.9597 120.318 24.7807 120.318 23.3265C120.318 21.8723 121.497 20.6934 122.952 20.6934ZM122.952 21.5013C123.96 21.5013 124.777 22.3184 124.777 23.3265C124.777 24.3346 123.96 25.1517 122.952 25.1517C121.944 25.1517 121.126 24.3346 121.126 23.3265C121.126 22.3184 121.944 21.5013 122.952 21.5013Z"
                  fill="#87AFFF"
                />
                <path
                  d="M122.952 24.5388C123.621 24.5388 124.164 23.9961 124.164 23.3265C124.164 22.657 123.621 22.1143 122.952 22.1143C122.282 22.1143 121.739 22.657 121.739 23.3265C121.739 23.9961 122.282 24.5388 122.952 24.5388Z"
                  fill="#0744BD"
                />
              </g>
              <defs>
          ...
          <span className="text-secondary-grey150   hidden sm:inline">|</span>
          <a
            href=""
            className="text-xs md:text-sm text-secondary-grey200 hidden sm:inline hover:text-foreground"
          >
            Doctor Onboarding
          </a>
          <span className="text-secondary-grey200 mx-1 hidden md:inline">
            ›
          </span>
      ...
      <div className="flex flex-1 overflow-hidden">
            ...
            <div className="flex items-center justify-center mb-3 mx-auto px-2">
              <div className="flex items-center justify-center bg-blue-primary50  rounded">
                <button
                  ...
                  className={`px-3 py-1 rounded-md text-sm font-medium transition-colors ${billingCycle === "monthly" ? "bg-blue-primary250 text-monochrom-white" : "text-secondary-grey300"}`}
                >
                  Billed Monthly
                </button>
                <button
                  onClick={() => setBillingCycle("halfYearly")}
                  className={`px-3 py-1 rounded-md text-sm font-medium transition-colors ${billingCycle === "halfYearly" ? "bg-blue-primary250 text-monochrom-white" : "text-secondary-grey300"}`}
                >
                  Billed Half-Yearly
                </button>
                <button
                  onClick={() => setBillingCycle("yearly")}
                  className={`px-3 py-1 rounded-md text-sm font-medium transition-colors ${billingCycle === "yearly" ? "bg-blue-primary250 text-monochrom-white" : "text-secondary-grey300"}`}
                >
                  Billed Annually
                </button>
              </div>
                ...
                {plans.map((plan) => {
                  ...
                  return (
                    <div
                      ...
                      className={`relative rounded-lg border cursor-pointer transition-all border-blue-primary400 p-4 ${isSelected ? " bg-blue-primary250 text-monochrom-white" : "bg-card hover:border-blue-primary150"}`}
                    >
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <div className="flex flex-col">
                          <h3
                            className={`text-sm font-semibold ${isSelected ? "text-monochrom-white" : "text-secondary-grey300"}`}
                          >
                            {plan.name}
                          </h3>
                          {isTrial ? (
                            <p
                              className={`text-xl font-bold ${isSelected ? "text-monochrom-white" : "text-blue-primary250"}`}
                            >
                              {plan.price}
                            </p>
                          ) : (
                            <div className="flex items-baseline gap-1">
                              ...
                              <span
                                className={`text-xl font-bold ${isSelected ? "text-monochrom-white/80" : "text-blue-primary250"}`}
                              >
                                {plan.period}
                              </span>
                              <span
                                className={`text-xs ${isSelected ? "text-monochrom-white/60" : "text-secondary-grey200"}`}
                              >
                                {plan.taxNote}
                              </span>
                            </div>
                      ...
                      <div className="mt-4">
                        <p
                          className={`text-xs mb-2 ${isSelected ? "text-monochrom-white/80" : "text-secondary-grey200"}`}
                        >
                          Access To:
                        </p>
        ...
        ${
          staff === 4
            ...
            {/* Footer */}
            <div className="flex items-center justify-between border-t border-border pt-2 pr-3">
              <button className="px-6 py-2 border border-border rounded-md text-sm font-medium text-secondary-grey400 hover:bg-muted">
                Cancel
              </button>
              <div className="flex items-center gap-3">
                <button className="flex items-center gap-2 text-sm text-secondary-grey300">
                  ← Previous
                </button>
                <button
                  onClick={handleContinue}
                  className="px-6 py-2 bg-blue-primary250 text-monochrom-white rounded-md text-sm font-medium hover:bg-blue-primary300 flex items-center gap-2"
                >
                  Confirm Purchase →
                </button>
              </div>
