...
export const doctorColumns = [
    {
        ...
        render: (row) => {
            const isActive = row.planStatus === 'Active';
            return (
    ...
    },
    {
        ...
        width: 140,
        render: (row) => <span className=" text-secondary-grey300">{row.startDate}</span>
    },
    {
        key: 'plan',
    ...
    },
    {
        ...
        width: 140,
        render: (row) => {
            const isSuspended = row.planStatus === 'Suspended';
            return (
                <Badge size="xs" color={isSuspended ? 'gray' : 'success'}>
                    {row.planStatus}
                </Badge>
            );
        }
